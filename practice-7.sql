...
SELECT listings.property_type, COUNT(*) reviews.reviews, reviews.date_reviewed
FROM reviews INNER JOIN listings.property_type ON listings.id = reviews.listing_id
GROUP BY listings.property_type ORDER BY reviews.date_reviewed;
